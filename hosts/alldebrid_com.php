...
if(empty($cookie)==false || ($user && $pass)){
	for ($j=0; $j < 2; $j++){
		...
		elseif (stristr($data,"Ip not allowed")) die("<font color=red><b>Ip host have been banned by alldebrid.com !</b></font>");
		elseif(isset($page['error']) && empty($page['error'])==false)  die('<font color=red><b>'.$page['error'].'</b></font>');
...
* Script Name: Vinaget 
* Version: 2.6.3
* Edited By MrBLAKEN [ Frenchdebrid.eu ]
*/
?>