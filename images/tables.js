...
function get(obj) {
	...
	for (i=0;i< linkdown.length;i++){
		if (i === 100) break;
		showlink = showlink+"<div id='link"+i+"'><font color=#FFFF99><b>"+linkdown[i]+"</b></font><br><br> <img src='images/loading.gif' /></div>";
...
function ajaxget(id,url,type){
	...
	captcha = 'none';
	if (type =='reget'){
		$("#link"+id).html("<font color=#FFFF99><b>"+url+"</b></font> <br><br><img src='images/loading.gif' />"); 
	}
	else if (type !=='get'){
		$("#link"+id).html("reload captcha... <br><br><img src='images/loading.gif' />"); 
		captcha = 'reload';
	}
